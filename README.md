...
<pre>
🚀 Passionate about building scalable and secure fullstack solutions using .NET technologies.
    Skilled in designing clean architectures with ASP.NET Core, C#, Entity Framework, and frontend technologies.
